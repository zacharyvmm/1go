...
#[unsafe(no_mangle)]
pub extern "C" fn scah_store_len(
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_store_get(
    store: *const ScahStore,
    ...
    ffi_guard(out_error, || {
        ...
        let found_ids: Option<Vec<ElementId>> = owned.store().get(query).map(|iter| {
            iter.map(|e| unsafe { owned.store().elements.index_of(e) })
                .collect()
        });
        match found_ids {
            None => {
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_store_free(store: *mut ScahStore) {
    ffi_guard_void(|| {
        if store.is_null() {
            return;
        }
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_list_len(
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_list_get(
    list: *const ScahElementList,
    index: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_list_free(list: *mut ScahElementList) {
    ffi_guard_void(|| {
        if list.is_null() {
            return;
        }
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_name(
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_id(
    element: *const ScahElement,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_class_name(
    element: *const ScahElement,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_inner_html(
    element: *const ScahElement,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_text_content(
    element: *const ScahElement,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_get_attribute(
    element: *const ScahElement,
    key: ScahStringView,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_attribute_count(
    element: *const ScahElement,
    out_count: *mut usize,
    out_error: *mut *mut ScahError,
) -> ScahStatus {
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_attribute_at(
    element: *const ScahElement,
    index: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_get(
    element: *const ScahElement,
    query: ScahStringView,
    out_elements: *mut *mut ScahElementList,
    out_found: *mut u8,
    ...
    ffi_guard(out_error, || {
        ...
        match el.get(element.store.store(), query) {
            ...
            Some(iter) => {
                ...
                let ids = iter
                    .map(|e| unsafe { store.store().elements.index_of(e) })
                    .collect();
                unsafe {
                    *out_found = 1;
                }
...
#[unsafe(no_mangle)]
pub extern "C" fn scah_element_free(element: *mut ScahElement) {
    ffi_guard_void(|| {
        if element.is_null() {
            return;
        }
...
mod tests {
    ...
    fn build_simple_query(selector: &str) -> *mut ScahQuery {
        ...
        assert_eq!(
            scah_query_all(view(selector), scah_save_all(), &mut builder, &mut err),
            ScahStatus::Ok
        );
        assert_eq!(
    ...
    fn parse_get_and_free_orders() {
        ...
        assert_eq!(
            scah_element_name(element, &mut name, &mut err),
            ScahStatus::Ok
        );
        assert_eq!(
        ...
        assert_eq!(
            scah_element_get_attribute(element, view("href"), &mut href, &mut err),
            ScahStatus::Ok
        );
    ...
    fn empty_queries_and_not_found() {
        let mut store: *mut ScahStore = std::ptr::null_mut();
        let mut err: *mut ScahError = std::ptr::null_mut();
        let status = scah_parse(view("<a></a>"), std::ptr::null(), 0, &mut store, &mut err);
        ...
        let mut found = 1u8;
        assert_eq!(
            scah_store_get(store, view("missing"), &mut list, &mut found, &mut err),
            ScahStatus::Ok
        );
        assert_eq!(found, 0);
        assert!(list.is_null());
    ...
    fn list_oob_and_optional_empty() {
        ...
        let mut element: *mut ScahElement = std::ptr::null_mut();
        assert_eq!(
            scah_element_list_get(list, 5, &mut element, &mut err),
